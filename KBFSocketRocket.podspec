...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "SocketRocket","SocketRocket/Internal/Utilities/*.{h,m}","SocketRocket/Internal/IOConsumer/*.{h,m}","SocketRocket/Internal/Delegate/*.{h,m}","SocketRocket/Internal/*.{h,m}","SocketRocket/Internal/Proxy/*.{h,m}","SocketRocket/Internal/RunLoop/*.{h,m}","SocketRocket/Internal/Security/*.{h,m}"
